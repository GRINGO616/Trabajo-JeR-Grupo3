class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        this.local_button.setInteractive().on('pointerdown', function () {
            if (musicON === true) {
                pulseEffect.play();
                menuMusic.volume = 0.0
            ...
            online=false;
            escena.scene.start("Login");
        })

        this.local_button.setInteractive().on('pointerover', () => {
            this.tweens.add({
        ...
        this.local_button.setInteractive().on('pointerout', () => {
            this.tweens.add({
                targets: this.local_button,
                duration: 200,
                scale: 1.0,
        ...
        this.online_button.setInteractive().on('pointerdown', function () {
            if (musicON === true) {
                pulseEffect.play();
                menuMusic.volume = 0.0
                levelSelectionMusic.volume = 0.4;
        ...
        this.online_button.setInteractive().on('pointerover', () => {
            this.tweens.add({
        ...
        this.online_button.setInteractive().on('pointerout', () => {
            this.tweens.add({
                targets: this.online_button,
                duration: 200,
                scale: 1.0,
